import"./support-eaba1970.js";document.querySelector(".bestsellers-area");const b=document.querySelector(".bestsellers-list");let d=document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth;d<768?$():d<1440?v():d>=1440&&x();function $(){fetch("https://books-backend.p.goit.global/books/top-books").then(e=>e.json()).then(e=>_(e)).catch(e=>console.log(e))}function _(e){b.innerHTML=e.map(t=>`<li class="bestsellers-list-item">
        ...
        </li>`).join(" "),g()}function v(){fetch("https://books-backend.p.goit.global/books/top-books").then(e=>e.json()).then(e=>C(e)).catch(e=>console.log(e))}function C(e){b.innerHTML=e.map(t=>`<li class="bestsellers-list-item">
        <p class="bestsellers-general-category">${t.list_name}</p>
