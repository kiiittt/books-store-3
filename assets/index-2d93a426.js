import"./support-eaba1970.js";document.querySelector(".bestsellers-area");const f=document.querySelector(".bestsellers-list");let u=[];const L=async()=>await(await fetch("https://books-backend.p.goit.global/books/top-books")).json();L().then(e=>{u=e,y(),k(u)}).catch(e=>console.error(e));let c=0,i=0;function y(){window.screen.availWidth<768?(c=1,i=30):window.screen.availWidth>=768&&window.screen.availWidth<1440?(c=3,i=20):(c=5,i=15)}function k(e){y();let o="";for(let t=0;t<e.length;t++){const s=e[t].list_name;o+=`
      ...
      </div>`}(()=>{const e={openModalBtn:document.querySelector(".bestsellers-area"),openModal:document.querySelector(".category_books_container"),closeModalBtn:document.querySelector("[data-modal-close]"),modal:document.querySelector("[data-modal]")};e.openModalBtn.addEventListener("click",o),e.closeModalBtn.addEventListener("click",t),window.addEventListener("keydown",s);function o(l){l.target.className==="bestsellers-book-cover"&&e.modal.classList.toggle("is-hidden")}function t(){e.modal.classList.toggle("is-hidden")}function s(l){l.key==="Escape"&&e.modal.classList.add("is-hidden")}})();const g=document.querySelector(".scroll-up_hidden"),oe=()=>{const e=window.pageYOffset,o=document.documentElement.clientHeight;e>o?g.classList.add("scroll-up"):g.classList.remove("scroll-up")},x=()=>{window.pageYOffset>0&&(window.scrollBy(0,-65),setTimeout(x,0))};g.addEventListener("click",x);window.addEventListener("scroll",oe);
